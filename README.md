# Construction QA Assistant

面向建筑公司的企业知识库问答项目，计划用于承载建筑规范、合同、施工方案、质量安全制度等资料的 RAG 检索与问答能力。

当前代码以 [FastGPT](https://github.com/labring/FastGPT) 开源版本为基础进行独立维护。仓库采用全新的提交历史，不包含上游仓库的 Git 历史；原项目许可证、LOGO 和版权信息按 [LICENSE](./LICENSE) 要求保留。

> 当前阶段为基础代码导入，后续将在本仓库中逐步完成建筑行业定制。
